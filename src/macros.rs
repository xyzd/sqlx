...
macro_rules! query_as_unchecked (
    ($out_struct:path, $query:literal) => (#[allow(dead_code)] {
        #[macro_use]
        mod _macro_result {
            $crate::sqlx_macros::expand_query!(record = $out_struct, source = $query, unchecked_output = true);
        }
        macro_result!()
    });
    ...
    ($out_struct:path, $query:literal, $($args:expr),*$(,)?) => (#[allow(dead_code)] {
        #[macro_use]
        mod _macro_result {
            $crate::sqlx_macros::expand_query!(record = $out_struct, source = $query, args = [$($args),*], unchecked_output = true);
        }
        macro_result!($($args),*)
    })
);
...
macro_rules! query_file_as_unchecked (
    ($out_struct:path, $path:literal) => (#[allow(dead_code)] {
        #[macro_use]
        mod _macro_result {
            $crate::sqlx_macros::query_file_as_unchecked!(record = $out_struct, source_file = $path, unchecked_output = true);
        }
        macro_result!()
    });
    ...
    ($out_struct:path, $path:literal, $($args:tt),*$(,)?) => (#[allow(dead_code)] {
        #[macro_use]
        mod _macro_result {
            $crate::sqlx_macros::query_file_as_unchecked!(record = $out_struct, source_file = $path, args = [$($args),*], unchecked_output = true);
        }
        macro_result!($($args),*)
    })
);
