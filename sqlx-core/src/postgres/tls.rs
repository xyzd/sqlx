...
pub(crate) async fn request_if_needed(stream: &mut PgStream, url: &Url) -> crate::Result<Postgres, ()> {
...
#[cfg(feature = "tls")]
async fn read_root_certificate(url: &Url) -> crate::Result<Postgres, Option<async_native_tls::Certificate>> {
